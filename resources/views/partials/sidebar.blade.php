            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item pt-5">
                    ...
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">MANAGE USERS</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
...
{{--                    </span>--}}
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">MANAGE FEEDBACK</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
...
{{--                    <span class="menu-link">--}}
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">MANAGE COMMENTS</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
